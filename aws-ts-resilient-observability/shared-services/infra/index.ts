...
// Export EKS cluster details for apps stack
...
export const eksClusterCertificateAuthority = sharedEksCluster.kubeconfig.apply(kc => {
    const config = typeof kc === 'string' ? JSON.parse(kc) : kc;
    return config.clusters[0].cluster["certificate-authority-data"];
});
export const eksOidcProviderArn = sharedEksCluster.oidcProviderArn;
export const eksOidcProviderUrl = sharedEksCluster.oidcIssuerUrl;
export const eksKubeconfig = sharedEksCluster.kubeconfig;
